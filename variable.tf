...
#************* Definitions of web workload project variables *********************
        web_project_id = {
...
# ****************** Definitions of web project Manged Instance group(MIG) variables ********
        web_instance_template_name = {
...
# ****************** Definitions project HTTPS Load Balancer variables ***********************
...
#******************* Definitions project loadbalancer backend static bucket Variables ***********
...
#******************* Definitions  project GKE variables *************************
...
#******************* Definitions  Cloud SQL Variables ***************************
...
#******************* Definitions of  Logsink to logging project Variable ***********
        web_project_log_sink_filter = {
    ...
    #devops_project_id example: "devops-project"
    devops_project_id                       = ""
    ...
    web_compute_http_health_check_name           = "web-http-health-check"
    web_compute_http_health_check_timeout_sec    = 30
    web_compute_http_health_check_interval_sec   = 30
    web_compute_http_health_check_healthy_threshold = 2
    web_compute_http_health_check_unhealthy_threshold = 2
    web_compute_http_health_check_request_path   = "/"
    web_compute_http_health_check_response       = ""
    web_compute_http_health_check_proxy_header   = "NONE"
